  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-12 mx-10">
        <motion.div
          className="space-y-4 py-8 px-10 bg-gray-500/10 rounded-2xl"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1 }}
        >
          <h3 className="font-semibold">
            <span className="border-b-2 border-white pb-2">Front</span>-end Development
          </h3>
        ...
        >
          <h3 className="font-semibold">
            <span className="border-b-2 border-white pb-2">Back</span>-end
          </h3>
        ...
        >
          <h3 className="font-semibold">
            <span className="border-b-2 border-white pb-2">Mobile</span> Development
          </h3>
        ...
        >
          <h3 className="font-semibold">
            <span className="border-b-2 border-white pb-2">Baas</span> and Database Management
          </h3>
